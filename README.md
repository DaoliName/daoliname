...
Like usual IBCs, DaoliNS also needs a PKG (Private Key Generator) to publicize system public parameters: ( P, Q=[s]P ) where is the so-called “Master secret key” of PKG.
